    ...
    >
      ...
      <div className="relative z-10 mx-auto flex min-h-[100svh] max-w-6xl items-end px-5 pb-28 pt-24 md:items-center md:px-8 md:pb-24 md:pt-20">
        <div className="hero-copy flex max-w-xl flex-col items-start">
          <p className="mb-4 text-xs font-medium tracking-[0.22em] text-gold-bright">
            كابتن أحمد العلاوي
          </p>
          <h1
            id="hero-title"
            className="font-display text-5xl font-semibold leading-[1.15] text-gold-bright md:text-6xl lg:text-7xl"
          >
            راحتك في بيتك
          </h1>
