        ...
        <Reveal delay={80}>
          <div className="glass-card max-w-3xl rounded-2xl p-5 md:p-6">
            <div className="flex flex-row items-start gap-4">
              <div className="size-24 shrink-0 overflow-hidden rounded-xl border-2 border-gold shadow-glow sm:size-32">
                <img
              ...
              <div className="min-w-0 flex-1 text-start">
                <h3 className="font-display text-xl font-semibold text-gold-bright sm:text-2xl">
                  كابتن أحمد العلاوي
                </h3>
